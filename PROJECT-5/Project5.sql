...
| ---------- | ----------------------------------------------------------- |
| FACT_SALES | Stores all sales transactions generated by retail branches. |
...
| Product_Name         |   | Customer_ID (FK)     |   | Date                 |
| Category             |   | Product_ID (FK)      |   | Day                  |
| Brand                |   | Branch_ID (FK)       |   | Day_Name             |
| Price                |   | Date_ID (FK)         |   | Week_No              |
+----------------------+   | Quantity             |   | Month                |
